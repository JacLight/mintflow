...
export const Button = (props: { id?, title?, type?, onClick?; controlRef?; iconSize?, isLoading?; label?; icon?; className?, unstyled?, children?}) => {
  ...
  return (
    <ButtonTooltip type={props.type || 'button'} id={props.id || props.title || getRandomString(6)} title={props.title} className={classNames(baseStyle, props.className)} onClick={onClick}>
