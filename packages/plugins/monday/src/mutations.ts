export const mondayGraphQLMutations = {
    ...
    updateItemName: `
    mutation updateItemName($itemId: ID!, $boardId: ID!, $itemName: String!) {
        update_name(item_id: $itemId, board_id: $boardId, column_values: $itemName) {
            id
            name
        }
    }`,
    ...
    uploadFileToColumn: `
    mutation uploadFileToColumn($itemId: ID!, $columnId: String!, $file: File!) {
