...
const ViewManager = ({
        ...
        <div className="flex items-center space-x-1">
            {!isModal && (
                <>
                    ...
                    >
                        {windowState === 'minimized' ? <IconRenderer icon='OutlineUnfoldMore' size={16} /> : <IconRenderer icon='Minimize' size={16} />}
                    </button>
                    <button
                    ...
                    >
                        {windowState === 'maximized' ? <IconRenderer icon='FullscreenExit' size={16} /> : <IconRenderer icon='Fullscreen' size={16} />}
                    </button>
                    <button
                        onClick={toggleDock}
                        className="p-1 hover:bg-gray-700 rounded text-white"
                    ...
                    >
                        <IconRenderer icon='PictureInPictureAlt' size={16} />
                    </button>
                    {windowState === 'normal' && (
                        <button
                            onClick={resetSize}
                            ...
                            title="Reset Size"
                        >
                            <IconRenderer icon='SettingsBackupRestore' size={16} />
                        </button>
                    )}
                </>
            )}
    ...
    const CompactMenu = () => (
        <div ref={menuRef} className="absolute top-2 right-2 z-50">
            ...
            >
                <IconRenderer icon='ArrowVertical' size={16} />
            </button>
